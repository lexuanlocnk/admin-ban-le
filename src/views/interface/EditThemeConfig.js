                        ...
                        <div className="position-relative px-2 py-1" style={{ zIndex: 2 }}>
                          ...
                          <CRow className="g-3 mb-3">
                            ...
                            <CCol md={3} xs={6}>
                              ...
                              >
                                ...
                                <div>
                                  📞 Hotline: <strong className="text-dark">1900 571 200</strong>
                                </div>
                          ...
                          <CRow className="g-3 align-items-center pt-2 border-top">
                            ...
                            <CCol xs={12}>
                              ...
                              >
                                <div>
                                  Giấy CNĐKDN số: 0310279545 do Sở Kế hoạch &amp; Đầu tư TP. HCM cấp
                                  ngày 28/09/2010.
                                </div>
                                <div>
                                  📍 Trụ sở: 245A Trần Quang Khải, Phường Tân Định, Quận 1, TP. Hồ
                                  Chí Minh
                                </div>
                                <div>
                                  📞 Tổng đài CSKH:{' '}
                    ...
                    {(activeColorPreviewTab === 'all' ||
                      ...
                      <div className="rounded-2 overflow-hidden border shadow-xs bg-white">
                        ...
                        <div
                          ...
                          style={{
                            backgroundColor: editingTheme?.colors?.header_main_bg || '#ffffff',
                            color: editingTheme?.colors?.header_main_text || '#222222',
                            outline:
                              activeColorPreviewTab === 'header_main'
                                ? '2px dashed #2563eb'
                                : undefined,
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{ color: editingTheme?.colors?.header_main_text || '#222222' }}
                          >
